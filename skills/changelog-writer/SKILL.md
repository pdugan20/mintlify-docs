...
Note: this is the one place house style uses the em-dash, as a gloss separator
inside changelog entries. Body docs follow the no-em-dash rule (best-practices
section 4).
